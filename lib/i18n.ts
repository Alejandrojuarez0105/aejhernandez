  ...
  es: {
    ...
    testimonials: {
      ...
      form: {
        ...
        emailNote: "No se publica. Solo para confirmar que el testimonio es tuyo.",
        message: "Testimonio",
        ...
        required: "El nombre, el rol, el correo y el testimonio son obligatorios.",
  ...
  en: {
    ...
    testimonials: {
      ...
      form: {
        ...
        emailNote: "Not published. Only to confirm the testimonial is yours.",
        message: "Testimonial",
        ...
        required: "Name, role, email and testimonial are required.",
